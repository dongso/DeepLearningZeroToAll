...
idx2char = ['h', 'i', 'e', 'l', 'o']  # 인덱스를 문자로 변환
...
num_classes = 5  # 범주
input_dim = 5  # 원핫 크기 one-hot size
hidden_size = 5  # LSTM 출력 크기 output from the LSTM. 5 to directly predict one-hot
batch_size = 1   # 한문장 one sentence
...
# 시퀀스 손실 함수 계산을 위해서 reshape 재배열. reshape out for sequence_loss
...
with tf.Session() as sess:
    ...
    for i in range(50):
        ...
        # 사전을 사용하여 문자 출력 print char using dic
